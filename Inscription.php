...
<body>  
   <div class="signup">
    <form action="new_inscription.php" method="POST" id="inscription_form">
     ...
     <input type="password" name="password" placeholder="Mot de passe"  title="Le mot de passe doit contenir 
       une lettre majuscule et miniscule, et au minimun 8 caracteres ou plus" required><br><br>    
     <input type="password" name="repass" id="repass" placeholder="Confirmez mot de passe"><br><br>   
